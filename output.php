...
?>
				...
				<div class="content">
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						...
						<div>
							...
							<a href="add-output.php" class="btn btn-primary link_data ">
								Add Output
							</a>
			...
			<!-- End Content Wrapper -->
			<!-- export sheet -->
			<button id="btnExport" onclick="fnExportToExcel('xlsx','output_sheet')" class="btn btn-outline-success">
			...
			<div class="ec-content-wrapper">
				<div class="content">
					...
					<div class="output_edit">
						<p>Please Enter Output From Here </p>
