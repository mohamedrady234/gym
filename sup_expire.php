...
if (isset($_SESSION['admin_login'])) {
	...
	if ($_SESSION['admin_username'] == "Male" or $_SESSION['admin_username'] == "admin") {
		$sql = "SELECT * FROM newmembers ORDER BY member_end DESC";
	} else {
		$sql = "SELECT * FROM newmembers_female ORDER BY member_end DESC";
	}
...
?>
											...
											<tbody>
												...
												?>
														...
														<tr>
															...
															<!-- <td><?php //if($_SESSION['admin_username'] == "Male" or $_SESSION['admin_username'] == "admin"){echo $row['member_id'];}else{echo $row['member_id_female'];} ; 
																		?></td> -->
															...
															<td class="action_trainer">
																<div class="btn-group">
																	<a href="edit_member_new.php?member_id=<?php if ($_SESSION['admin_username'] == "Male" or $_SESSION['admin_username'] == "admin") {
																												echo $row['member_id'];
																											} else {
																												echo $row['member_id_female'];
																											}; ?>?page=sup_expire" class="btn btn-outline-success">
																		Edit
																	</a>
			...
			<!-- End Content Wrapper -->
			<!-- export sheet -->
			<button id="btnExport" onclick="fnExportToExcel('xlsx','new_sup_expire_sheet')" class="btn btn-outline-success">
