...
if (isset($_SESSION['admin_login'])) {
	...
	if ($_SESSION['admin_username'] == "Male" or $_SESSION['admin_username'] == "admin") {
		$sql = "SELECT * FROM newmembers";
	} else {
		$sql = "SELECT * FROM newmembers_female";
	}
...
?>
											...
											<tbody>
												...
												?>
													...
													<tr>
														...
														<td>
															<a href="show_member_new.php?member_id=<?php
																									if ($_SESSION['admin_username'] == "Male"  or $_SESSION['admin_username'] == "admin") {
																										echo $row['member_id'];
																									} else {
																										echo $row['member_id_female'];
														...
														<td class="action_trainer">
															<div class="btn-group">
																...
																?>
																	<a href="delete_member_new.php?member_id=<?php if ($_SESSION['admin_username'] == "Male" or $_SESSION['admin_username'] == "admin") {
																													echo $row['member_id'];
																												} else {
																													echo $row['member_id_female'];
																												}; ?>" class="btn btn-outline-success">
			...
			<!-- End Content Wrapper -->
			<!-- export sheet -->
			<button id="btnExport" onclick="fnExportToExcel('xlsx','new_member_sheet')" class="btn btn-outline-success">
