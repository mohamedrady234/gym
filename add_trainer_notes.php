			...
			<div class="ec-content-wrapper">
				<div class="content">
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							<h1>Add Trainer Notes</h1>
							
						</div>
						<div>
							<a href="trainer_list.php" class="btn btn-primary"> View All
							</a>
						</div>
					</div>
					<div class="row">
												...
												<?php
														...
														if(isset($_POST['submit']))
														{
															...
															)
															{
																...
																$sql = "INSERT INTO trainernotes VALUES(NULL,
																								'$name',
																								'$disc',
																								'$paid_up',
																								'$day'
																...
																if($result)
																{
																		...
																		redirect("1","trainer_list.php");
																}else
																{
																	
																	outputmsg("info" ,"error after sql ");
																	include_once("looding.php");
																	redirect("1","add_trainer_notes.php");
														...
														}else
														{
															...
															?>
																...
																<form class="row g-3" method="post" action="<?php reusable_action(); ?>" enctype="multipart/form-data">
																	...
																	<div  class="col-md-6">
																		<label for="inputEmail4" class="form-label">Coach Name</label>
