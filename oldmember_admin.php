...
if (isset($_SESSION['admin_login'])) {
	...
	$sql_male = "SELECT * FROM members";

	$sql_female = "SELECT * FROM members_female";
													...
													<tr>
														...
														<td class="action_trainer">
															<div class="btn-group">
																...
																?>
																	<a href="delete_member.php?member_id=<?php echo $row['member_id']; ?>" class="btn btn-outline-success">
																		Delete
																	</a>
																<?php
																}
