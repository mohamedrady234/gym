...
if (isset($_SESSION['admin_login'])) {
    ...
    if (isset($_GET['member_id'])) {
        ...
        if ($_SESSION['admin_username'] == "Male" or $_SESSION['admin_username'] == "admin") {
            $sql = "SELECT * FROM newmembers WHERE member_id = $member_id";
        } else {
            $sql = "SELECT * FROM newmembers_female WHERE member_id_female  = $member_id";
        }
        ...
        if ($result) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                if (isset($_POST["submit"])) {
                    ...
                    // if($member_name_captain = NULL){
                    //     $member_name_captain= "null" ;
                    // }
                    if (
                        ...
                        if ($count > 0) {
                            ...
                            redirect("2", "new_members.php");
                        } else {

                            if ($_SESSION['admin_username'] == "Male" or $_SESSION['admin_username'] == "admin") {
                                $sql_update = "UPDATE  newmembers SET 
                                ...
                                $sql_update = "UPDATE  newmembers_female SET 
                                member_name          = '$member_name',
                                member_subscription  = '$member_subscription',
                                member_phone         = '$member_phone',
                                member_name_captain  = '$member_name_captain',
