...
if (isset($_SESSION['admin_login'])) {
	...
	if ($_SESSION['admin_username'] == "Male" or $_SESSION['admin_username'] == "admin") {
		$sql = "SELECT * FROM members ORDER BY member_end DESC  ";
	} else {
		$sql = "SELECT * FROM members_female ORDER BY member_end DESC ";
	}
...
?>
			...
			<!-- End Content Wrapper -->
			<!-- export sheet -->
			<button id="btnExport" onclick="fnExportToExcel('xlsx','old_sup_expire_sheet')" class="btn btn-outline-success">
